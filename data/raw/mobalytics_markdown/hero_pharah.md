[![Mobalytics](https://cdn.mobalytics.gg/assets/common/icons/mobalytics-logo/logo-mobalytics-expanded-fixed.svg)](https://mobalytics.gg/overwatch/heroes/pharah-guide/overwatch)
...
[DOWNLOAD APP](https://mobalytics.gg/overwatch/heroes/pharah-guide/lol/glp/download-welcome?Channel=web%5Fdl%5Fbtn&utm%5Fcampaign=top-overwatch&utm%5Fmedium=homepage&utm%5Fsource=web)

[News](https://mobalytics.gg/overwatch/heroes/pharah-guide/news)
...
[![menu](https://cdn.mobalytics.gg/assets/common/icons/mobalytics-logo/logo-mobalytics-collapsed-fixed.svg)](https://mobalytics.gg/overwatch/heroes/pharah-guide/overwatch)

[![Home](https://cdn.mobalytics.gg/assets/common/icons/side-menu-icon/dashboard.svg)Home](https://mobalytics.gg/overwatch/heroes/pharah-guide/overwatch)

[![Profile](https://cdn.mobalytics.gg/assets/common/icons/side-menu-icon/profile.svg)Profile](https://mobalytics.gg/overwatch/heroes/pharah-guide/overwatch/profile)

[![Heroes](https://cdn.mobalytics.gg/assets/common/icons/side-menu-icon/champions.svg)Heroes](https://mobalytics.gg/overwatch/heroes/pharah-guide/overwatch/heroes)
...
# Overwatch Overwatch Pharah Guide and Overview

In this Overwatch Pharah guide, you'll learn the fundamentals of their abilities, unique play styles, and fundamental tips. Master ability combos, positioning, and matchup knowledge to excel with other Overwatch [heroes](https://mobalytics.gg/overwatch/heroes/pharah-guide/overwatch/heroes)!

## Pharah Overview

The OG flying hero of Overwatch, ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/pharah.png)Pharah, dominates the skies as she rains rockets down on her targets. More movement abilities than any other hero allow her to navigate map terrain in a completely unique way. 
...
Against enemy comps with primarily short-range abilities, Pharah becomes one of the best poke heroes due to ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/rocket-launcher.png)Rocket Launcher having zero falloff damage and good AoE splash damage. 
...
* Use ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/barrage.png)Barrage from unexpected positions or when coordinated with protection from an ally, such as a ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/projected-barrier.png)Projected Barrier or ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/defense-matrix.png)Defense Matrix.

#### Playing Against

* The best way to deal with ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/pharah.png)Pharah is to play a hitscan with range and burst damage like ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/ashe.png)Ashe or ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/illari.png)Illari.
...
The ability to take to the sky, fly over buildings, and remain in the air puts Pharah in a league of her own in controlling the vertical plane. For enemies shooting at Pharah, adjusting their aim vertically is generally accepted as being more difficult than horizontal adjustments. Correct usage of ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/hover-jets.png)Hover Jets and ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/jump-jet.png)Jump Jet creates consistent pressure from angles that only Pharah can position herself in. 

Just the dividing of attention from the enemy team can be enough to make a team with a good Pharah playing feel unstoppable. Her vertical movement also allows her to create pathing options over environments that would typically not be possible for most of the cast. 

#### Excellent at using cover

![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/rocket-launcher.png)Rocket Launcher’s slow rate of fire makes Pharah excel at quickly peeking in and out of cover, only exposing herself while firing a rocket. When grounded, she can do this by strafing around a wall. In the air, Hover Jets allow Pharah to use the tops of buildings and structures to peek above, shoot, and dip below to safety. 

#### Quickly engage and disengage

Combining Rocket jumps, Jet Dash, and Concussive Blast self-knockback give Pharah access to multiple instances of high bursts of speed. Depending on the map and situation, she can quickly engage or dive a target with one of her cooldowns, get an elimination, then use her remaining abilities to retreat to safety until all her resources are restored. 

Cycling Pharah’s movement cooldowns is extremely important for maximizing her impact and potential. 

### Weaknesses

#### Slow projectile speed

From medium to long range, Pharah can struggle to land direct impacts due to the slow projectile speed of ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/rocket-launcher.png)Rocket Launcher. At very long ranges, enemies with movement abilities have plenty of time to reactively dodge incoming rockets. 

Pharah players need to become really good at predicting movement in order to maximize damage output. Damage mitigation abilities like ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/defense-matrix.png)Defense Matrix and barriers can also be used reactively to prevent any rocket damage from being dealt. 

#### Often dies during her own Ultimate

“Justice Rains fro… uggghhhh!” Pharah makes herself into a stationary bullseye while she ults. Headshots, CC abilities, damage mitigation abilities and every attack can easily save enemies from death and eliminate Pharah before she has a chance to move again. 

Typically, players will need to coordinate with a teammate if they hope to survive using ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/barrage.png)Barrage. Abilities like ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/protection-suzu.png)Protection Suzu and ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/projected-barrier.png)Projected Barrier can change Barrage from being deadly to herself to being deadly to the enemy team.

#### Hitscans

While the rework has given ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/pharah.png)Pharah much more counterplay against hitscans, she still can be quickly eliminated by players with good aim mechanics on a hitscan hero. 

Pharah has the benefit of mobility and no falloff damage, but these struggle to make up for how reliably and quickly hitscan abilities deal damage to her. Pharah’s normal hover jet movement is rather slow and makes her an easy target for heroes like ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/ashe.png)Ashe, ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/baptiste.png)Baptiste, and ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/mauga.png)Mauga. 

## Pharah Ability Tips

### Positioning and Playstyle

While playstyle ultimately depends on the individual player, the optimal way to play ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/pharah.png)Pharah should always adapt to the map and the enemy team composition.
...
When playing into poke comps with multiple hitscan heroes, ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/jet-dash.png)Jet Dash toward wider flank angles and spend more time closer to the ground. Open skies become too exposed, so using natural cover and off-angles is critical for survival.
...
A Rocket Jump uses ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/rocket-launcher.png)Rocket Launcher to give Pharah a small burst of movement in her current direction.

* Can be combined with ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/hover-jets.png)Hover Jets, ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/jump-jet.png)Jump Jet, ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/jet-dash.png)Jet Dash, and ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/concussive-blast.png)Concussive Blast.
...
* Using ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/barrage.png)Barrage makes you extremely vulnerable. When possible, ask for ally protection like ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/defense-matrix.png)Defense Matrix, ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/projected-barrier.png)Projected Barrier or ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/protection-suzu.png)Protection Suzu.
* Ideally, you will sneak up on your targets by dropping from high ground or by sliding down a roof or ledge. All her jets are very loud and will alert the enemy to your position.

### Advanced Movement Tech

#### Dash → Concussive Jump

Use ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/jet-dash.png)Jet Dash, then immediately ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/abilities/concussive-blast.png)Concussive Blast jump while within blast radius.
...
* Considering Pharah has two movement abilities, you get to activate the mini-rockets pretty often. Good for extra damage and better AoE.
* New total on direct hit is 200
...
![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/d-va.png)D.Va, ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/pharah.png)Pharah, ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/tracer.png)Tracer, ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/mercy.png)Mercy, ![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/ana.png)Ana  
...
![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/sojourn.png)Sojourn  
...
![](https://cdn.mobalytics.gg/cdn-cgi/image/format=auto,width=96/assets/overwatch/images/heroes/mauga.png)Mauga  
